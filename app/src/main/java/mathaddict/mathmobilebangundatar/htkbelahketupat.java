...
public class htkbelahketupat extends AppCompatActivity {
    EditText d1,d2;
    Button hitung;
    TextView hasil;
    Button reset;
    ...
    public void init1(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent toy1= new Intent(htkbelahketupat.this,MainActivity.class);
                startActivity(toy1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_htkbelahketupat);
        ...
        hitung.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (d1.length() == 0 && d2.length() ==0) {
                    ...
                    double hs = Luasbelahketupat (d1,d2);
    ...
    }public double Luasbelahketupat (double d1, double d2){return (d1*d2)/2 ;}
}