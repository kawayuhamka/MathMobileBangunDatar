...
public class htkjajargenjang extends AppCompatActivity {
    EditText a,t;
    Button hitung;
    TextView hasil;
    Button reset;
    ...
    public void init1(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent toy1= new Intent(htkjajargenjang.this,MainActivity.class);
                startActivity(toy1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_htkjajargenjang);
    ...
    }public double Luasjajargenjang (double a, double t){return a*t;}
}
